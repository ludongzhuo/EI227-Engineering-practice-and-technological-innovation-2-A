  ...
  ui32SysClock = SysCtlClockFreqSet((SYSCTL_XTAL_16MHZ |SYSCTL_OSC_INT |SYSCTL_USE_OSC), 16000000);		
	...
	{	
		if(systick_100ms_status==1)
		{
			...
			result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,seg7[value+1]);		//write port 1 	
		  result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,1<<value);					//write port 2
		
		  result = I2C0_WriteByte(PCA9557_I2CADDR,PCA9557_OUTPUT,~(1<<value));	
	    value++;
		  if(value==8) value=0;
		}
